...
/// Use a GlobalKey to access the state. This is the only way to call [GradientSliderState.reset]
              ...
              ? Transform(
                  ...
                  child: Center(
                    child: Stack(
                      ...
                      children: <Widget>[
                        widget.submittedIcon ?? widget.icon,
                        Positioned.fill(
                          right: 0,
                          child: Transform(
                            transform:
